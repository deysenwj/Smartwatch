  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center px-4 py-16 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-4xl mt-8 z-10">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-24 h-24 bg-[#0d1b3e] rounded-full flex items-center justify-center overflow-hidden shadow-xl border-4 border-slate-50 dark:border-slate-955">
